            ...
            <tbody>
                <?php $no = 1 ?>
                    <tr>
                        ...
                        <td>
                            <a href="#" data-toggle="modal" data-target="#modaltambahdata"><span style="color: blue;"><i class="fas fa-plus"></i></span></a>
                        </td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#modaleditdata"><span style="color: blue;"><i class="fas fa-edit"></i></span></a>
                        </td>
                    </tr>
